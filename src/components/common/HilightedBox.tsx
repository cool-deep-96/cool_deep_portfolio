...
const HilightedBox = ({children}:HilightedBoxPropsType) => {
  ...
  const [isMouseEntered, setIsMouseEnterd]= useState<boolean>(false)
    ...
    const handleMouseMove = (e:any)=>{
      ...
      const rX=(mouseX/width - 0.5) * 7;
      const rY = (mouseY/height-0.5) * 5;
  ...
  return (
    ...
    className={` w-11/12 bg-slate-900 mb-10  duration-300
